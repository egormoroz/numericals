...
Это даёт 2n - 2 уравнений (где n - кол-во точек). 

Условие совпадения производных даёт ещё n - 2 уравнения, так что сейчас у нас 
2n - 2 + n - 2 = 3n - 4. Не хватает одного уравнения, так что мы добавляем
ещё одно граничное условие на производную (здесь производная в правой границе равна нулю).
